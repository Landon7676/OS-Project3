...
#include <thread>
using namespace std;
const int MAX = 100; // the maximum possible value of the internal counter for
semaphores
int buffer; // shared buffer, size = 1
int numIters;
// deposit 1, ..., numIters into the data buffer
void Producer(counting_semaphore<MAX> &sem_empty, counting_semaphore<MAX>
&sem_full)
{
...
void Consumer(counting_semaphore<MAX> &sem_empty, counting_semaphore<MAX>
&sem_full)
{
int total = 0;
